...
var defaultProps = {
  ...
  function Select(_props) {
    ...
    _this.controlRef = null, _this.getControlRef = function(ref) {
      ...
      "boolean" == typeof _this.props.closeMenuOnScroll ? event.target instanceof HTMLElement && utils.isDocumentElement(event.target) && _this.onMenuClose() : "function" == typeof _this.props.closeMenuOnScroll && _this.props.closeMenuOnScroll(event) && _this.onMenuClose();
  ...
  return _proto.componentDidMount = function() {
    this.startListeningComposition(), this.startListeningToTouch(), this.props.autoFocus && this.focusInput();
    ...
    this.props.isMenuOpen || (this.props.closeMenuOnScroll && document && document.addEventListener && document.addEventListener("scroll", this.onScroll, !0), 
    ...
    this.props.isMenuOpen && (this.props.closeMenuOnScroll && document && document.removeEventListener && document.removeEventListener("scroll", this.onScroll, !0), 
